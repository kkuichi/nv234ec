...
def compute_shap_importance(
    ...
    """
    if not HAS_SHAP:
        logger.warning("SHAP nie je nainštalovaný, SHAP analýzu preskakujem")
        return None

    max_samples = max_samples or CONFIG.SHAP_MAX_SAMPLES

    logger.info("Počítam SHAP hodnoty (max. %d vzoriek)...", max_samples)
    ...
    try:
        ...
        logger.info("SHAP analýza dokončená. Najdôležitejšie príznaky:")
        ...
        logger.warning("SHAP analýza zlyhala: %s", exc)
        return None
