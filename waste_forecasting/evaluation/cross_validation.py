...
Modul poskytuje funkciu run_cross_validation, ktorá spustí
krížovú validáciu nad tréningovou množinou pre všetky modely
z CONFIG.MODELS_TO_COMPARE. Používa rovnakú
...
takže výsledky sú najbližšie k Experimentu A. Používa sa na
dodatočné overenie stability metrík naprieč foldmi.
"""
...
def run_cross_validation(
    ...
    """
    logger.info("=" * 70)
    logger.info(f"{CONFIG.N_FOLDS}-fold krížová validácia naprieč modelmi")
    logger.info("=" * 70)

    # --- Príprava datasetu vývozov -----------------------------------
    ...
    for fold_idx, (train_df, val_df) in enumerate(folds):
        ...
        # Kódovanie kategoriálnych premenných je naučené na trénovacom
        # folde a aplikované na validačnú časť bez úniku informácií.
        ...
        # Každý model sa trénuje s predvolenými parametrami.
        # CV tu odhaduje variabilitu, nie optimalizáciu.
        # Hyperparametre sa preto neladia.
