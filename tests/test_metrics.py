"""Jednotkové testy pre regresné metriky.

Overujú sa základné vlastnosti troch metrík z modulu
waste_forecasting.models.metrics:

* RMSE - musí byť 0 pri perfektnej predikcii a presne 1,
  keď je každá predikcia posunutá o 1 (konštantná chyba).
* MAE - musí správne narábať s chybami so zmiešanými
  znamienkami (absolútna hodnota).
* Agregovaný výstup calculate_all_metrics - musí obsahovať
  všetky očakávané kľúče (rmse, mae, wape, smape,
  r2, n) a produkovať rozumné hodnoty pre syntetické dáta
  s malým Gaussovým šumom.
"""
